...
10.  Tìm **Add Triggers** trong thẻ **Function overview**.

![UpdateLambda](/images/2/13.png?width=90pc)

11. Chọn S3.
12. Tại mục **Bucket** chọn bucket mà bạn đã tạo để chứa hình ảnh tải lên (idevelop-imagemanager-yourinitials)
13. Tại mục **Event type** chọn **All Object create events**
14. Tại mục **Prefix** nhập **uploads/**. Không đặt giá trị **Suffix**.
