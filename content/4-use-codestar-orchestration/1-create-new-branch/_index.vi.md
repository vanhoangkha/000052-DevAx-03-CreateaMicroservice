...
2. Chúng ta sẽ cần tạo service role cho code star trong lần đầu tiên sử dụng. Click **Create service role**. Bạn sẽ thấy nhiều thẻ template.
...
6. Chọn **Team**, chọn **Add team member** 
